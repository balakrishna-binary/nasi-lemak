					...
					<div class="width-100">
						...
						<div class="width-100 d-flex jc-center flex-row input-wrapper">
							<div class="form__group mr-1">
								<input type="text" class="form__input width-100" id="mobile" placeholder="Mobile" />
								<label for="name" class="form__label">Mobile</label>
							</div>
							<div class="form__group">
								<input type="text" class="form__input width-100" id="phone" placeholder="Phone" />
						...
						<div class="width-100 d-flex jc-center flex-row input-wrapper">
							<div class="form__group">
								<input type="email" class="form__input width-100" id="email" placeholder="Email" />
